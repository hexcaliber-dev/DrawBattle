...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"newTexture\"]]")]
	public abstract partial class ProjectileBehavior : NetworkBehavior
	{
		public const byte RPC_CHANGE_TEXTURE = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("ChangeTexture", ChangeTexture, typeof(byte[]));
		...
		/// byte[] newTexture
		/// </summary>
		public abstract void ChangeTexture(RpcArgs args);
