...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class PlayerControllerNetworkObject : NetworkObject
	{
		...
		public event FieldEvent<int> playerNumChanged;
		public Interpolated<int> playerNumInterpolation = new Interpolated<int>() { LerpT = 0f, Enabled = false };
		...
		protected override void ReadPayload(BMSByte payload, ulong timestep)
		{
			...
			_playerNum = UnityObjectMapper.Instance.Map<int>(payload);
		...
		protected override void ReadDirtyFields(BMSByte data, ulong timestep)
		{
			...
			if ((0x4 & readDirtyFlags[0]) != 0)
			{
				...
				{
					playerNumInterpolation.target = UnityObjectMapper.Instance.Map<int>(data);
					playerNumInterpolation.Timestep = timestep;
				}
				else
				{
					_playerNum = UnityObjectMapper.Instance.Map<int>(data);
					RunChange_playerNum(timestep);
				}
			}
		}
		...
		public override void InterpolateUpdate()
		{
			...
			{
				_playerNum = (int)playerNumInterpolation.Interpolate();
