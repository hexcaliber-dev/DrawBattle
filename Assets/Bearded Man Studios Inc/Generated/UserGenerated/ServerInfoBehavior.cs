...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class ServerInfoBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (ServerInfoNetworkObject)obj;
		...
		{
			Initialize(new ServerInfoNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new ServerInfoNetworkObject(networker, this, createCode, metadata);
		}
		...
		/// Arguments:
		/// </summary>
		public abstract void LeaveGame(RpcArgs args);
