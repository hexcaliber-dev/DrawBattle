...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class PlayerObjNetworkObject : NetworkObject
	{
		...
		public PlayerObjNetworkObject() : base() { Initialize(); }
		public PlayerObjNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public PlayerObjNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
